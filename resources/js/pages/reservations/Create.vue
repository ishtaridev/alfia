...
import { index as reservationsIndex, store as reservationsStore } from '@/routes/offer-variants/reservations';
...
const submit = () => {
    ...
    router.post(reservationsStore(props.offerVariant.id).url, {
...
<template>
    <Head :title="t('reservations.create.title')" />

    <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-4">
        <div class="flex items-center justify-between">
            <Heading
                :title="t('reservations.create.title')"
                :description="offerVariant.offer.title"
            />
        ...
        <div class="mx-auto w-full max-w-2xl space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{{ t('reservations.create.form_title') }}</CardTitle>
                    <CardDescription>{{ t('reservations.create.form_description') }}</CardDescription>
                </CardHeader>
                <CardContent>
                    <form @submit.prevent="submit" class="space-y-6">
                        <div class="grid gap-6 sm:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <Input
                                    id="customer"
                                    v-model="customer"
                                    :placeholder="t('reservations.create.customer_placeholder')"
                                    required
                                />
                            ...
                            <div class="space-y-2">
                                ...
                                <Input
                                    id="phone"
                                    v-model="phone"
                                    :placeholder="t('reservations.create.phone_placeholder')"
                                    required
                                />
                            ...
                            <div class="space-y-2">
                                ...
                                <Select v-model="room_type">
                                    ...
                                    <SelectContent>
                                        <SelectItem value="collectif">{{ t('reservations.room_type.collectif') }}</SelectItem>
                                        <SelectItem value="room_of_four">{{ t('reservations.room_type.room_of_four') }}</SelectItem>
                                        <SelectItem value="room_of_three">{{ t('reservations.room_type.room_of_three') }}</SelectItem>
                                        <SelectItem value="room_of_two">{{ t('reservations.room_type.room_of_two') }}</SelectItem>
                                    </SelectContent>
                                </Select>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            />
                            <Label for="include_feeding" class="cursor-pointer">{{ t('reservations.index.include_feeding') }}</Label>
                        </div>
